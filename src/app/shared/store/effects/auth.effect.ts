...
// ++++++++++++++++++    private authApiClient: AuthApiClient,
  ...
  doLogin$: Observable<Action> = this.actions$
    ...
    .pipe(map((action: actions.DoLoginAction) => action.payload))
    .switchMap(state => {
  ...
  doRegister$: Observable<Action> = this.actions$
    ...
    .pipe(map((action: actions.DoRegisterAction) => action.payload))
    .switchMap(state => {
  ...
  doLogout$: Observable<Action> = this.actions$
    ...
    .pipe(map((action: actions.DoLogoutAction) => null))
    .switchMap(state => {
